...
var sampleText = "YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE YIPPEE cock";
...
function createTextObjectIfneeded(text, ctx, textLineHeight, canvasWidth){
    ...
    if(!TEXT_MAP.has(text)){
        ...
        textObject.charIndex = 60;
        textObject.lineIndex = 2;
